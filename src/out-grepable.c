...
static void grepable_out_open(struct Output *out, FILE *fp) {
  ...
  count = count_type(&out->masscan->targets.ports, Templ_Oproto_first,
                     Templ_Oproto_last);
 ...
 * or "closed".
 ****************************************************************************/
static void grepable_out_status(struct Output *out, FILE *fp, time_t timestamp,
 ...
 ****************************************************************************/
static void grepable_out_banner(struct Output *out, FILE *fp, time_t timestamp,

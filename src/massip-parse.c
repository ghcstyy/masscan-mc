...
/***************************************************************************
 ***************************************************************************/
static void _parser_destroy(struct massip_parser *p) { UNUSEDPARM(p); }

/***************************************************************************
 ***************************************************************************/
static void _parser_err(struct massip_parser *p,
                        unsigned long long *line_number,
 ...
 ***************************************************************************/
static void _parser_get_ipv6(struct massip_parser *state, ipv6address *begin,
                             ipv6address *end) {
 ...
 */
static void _ipv4_apply_cidr(unsigned *begin, unsigned *end,
                             unsigned bitcount) {
 ...
 */
static void _ipv6_apply_cidr(ipv6address *begin, ipv6address *end,
                             unsigned prefix) {
  ipv6address mask;
...
static enum {
  ...
  Found_IPv4,
  Found_IPv6
} _parser_next(struct massip_parser *p, const char *buf, size_t *r_offset,
 ...
 ***************************************************************************/
static int rangefile_test_error(const char *buf,
...
enum RangeParseResult massip_parse_range(const char *line, size_t *offset,
...
static int selftest_massip_parse_range(void) {
  struct testcases {
    ...
    union {
      ...
      {"0.0.1.0-0.0.1.255,0.0.3.0-0.0.4.0",
       {{{0x100, 0x1ff}}, {{0x300, 0x400}}}},
      {"0.0.1.0/24 0.0.3.0-0.0.4.0", {{{0x100, 0x1ff}}, {{0x300, 0x400}}}},
      {0}};
  size_t i;
...
struct {
  ...
  ipv6address end;
    ...
    {"[1::1]/126",
     {0x0001000000000000ULL, 0ULL},
     {0x0001000000000000ULL, 3ULL}},
    {"1::1/126", {0x0001000000000000ULL, 0ULL}, {0x0001000000000000ULL, 3ULL}},
    {"[1::1]-[2::3]",
     {0x0001000000000000ULL, 1ULL},
     {0x0002000000000000ULL, 3ULL}},
    ...
    {"240e:33c:2:c080:d08:d0e:b53:e74e",
     ...
     {0x240e033c0002c080ULL, 0x0d080d0e0b53e74eULL}},
    {"2a03:90c0:105::9",
     {0x2a0390c001050000ULL, 9ULL},
     {0x2a0390c001050000ULL, 9ULL}},
    {"2a03:9060:0:400::2",
     {0x2a03906000000400ULL, 2ULL},
     {0x2a03906000000400ULL, 2ULL}},
    ...
    {"2a01:5b40:0:4a01:0:e21d:789f:59b1",
     ...
     {0x2a015b4000004a01ULL, 0x0000e21d789f59b1ULL}},
    {"2001:1200:10::1",
     {0x2001120000100000ULL, 1ULL},
     {0x2001120000100000ULL, 1ULL}},
    {"fec0:0:0:ffff::1",
     {0xfec000000000ffffULL, 1ULL},
     {0xfec000000000ffffULL, 1ULL}},
    {"1234:5678:9abc:def0:0fed:cba9:8765:4321",
     {0x123456789abcdef0ULL, 0x0fedcba987654321ULL},
     {0x123456789abcdef0ULL, 0x0fedcba987654321ULL}},

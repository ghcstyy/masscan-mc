 ...
 * @param ip_dst
 *      The destination IPv4 address, represented as a 32-bit integer in host
 * byte order.
 * @param ip_proto
 *      A value of 6 for TCP or 17 for UDP.
 * @param payload_length
 *      The length of the IP packet payload, meaning, everything after the IPv4
 * header. In other words, it's the "total length" field of the IP packet minus
 ...
 * the payload we use is everything but the 2 bytes in the checksum field. Thus,
 * due to the quirkiness of Internet protocols, the result of this calculation
 * should end up equally the value of the checksum field.
 * @return

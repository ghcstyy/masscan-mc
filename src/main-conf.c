...
void masscan_usage(void)
{
    ...
    printf(
        "        read binary scan results in <filename> and save them as xml "
        "in <savefile>\n");
    exit(1);
}
...
/***************************************************************************
 ***************************************************************************/
static void print_nmap_help(void)
{
    printf(
 ...
 ***************************************************************************/
static void masscan_echo_nic(struct Masscan* masscan, FILE* fp, unsigned i)
{
    char idx_str[64];
...
static int parse_mac_address(const char* text, macaddress_t* mac)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        while (isspace(*text & 0xFF) && ispunct(*text & 0xFF)) text++;
 ...
 * 3600
 ***************************************************************************/
static uint64_t parseTime(const char* value)
{
    uint64_t num = 0;
    ...
    while (ispunct(value[0]) || isspace(value[0])) value++;
...
static unsigned INDEX_OF(const char* str, char c)
{
    unsigned i;
...
static unsigned ARRAY(const char* rhs)
{
 ...
 */
static void config_top_ports(struct Masscan* masscan, unsigned maxports)
{
    unsigned i;
    ...
    static const unsigned short top_tcp_ports[] = {
        ...
        1,     3,     4,     6,     7,     9,     13,    17,    19,    20,    26,    30,    32,
        33,    37,    42,    43,    49,    70,    79,    81,    82,    83,    84,    85,    89,
        90,    99,    100,   106,   109,   110,   113,   119,   125,   143,   144,   146,   161,
        163,   179,   199,   211,   212,   222,   254,   255,   256,   259,   264,   280,   301,
        306,   311,   340,   366,   406,   407,   416,   417,   425,   427,   444,   458,   464,
        465,   481,   497,   500,   512,   513,   514,   515,   524,   541,   543,   544,   545,
        554,   555,   563,   593,   616,   617,   625,   631,   646,   648,   666,   667,   668,
        683,   687,   691,   700,   705,   711,   714,   720,   722,   726,   749,   765,   777,
        783,   787,   800,   801,   808,   843,   873,   880,   888,   898,   900,   901,   902,
        903,   911,   912,   981,   987,   993,   995,   999,   1000,  1001,  1002,  1007,  1009,
        ...
        1097,  1100,  1102,  1104,  1105,  1106,  1107,  1108,  1110,  1111,  1112,  1113,  1114,
        1117,  1119,  1121,  1122,  1123,  1124,  1126,  1130,  1131,  1132,  1137,  1138,  1141,
        1145,  1147,  1148,  1149,  1151,  1152,  1154,  1163,  1164,  1165,  1166,  1169,  1174,
        1175,  1183,  1185,  1186,  1187,  1192,  1198,  1199,  1201,  1213,  1216,  1217,  1218,
        1233,  1234,  1236,  1244,  1247,  1248,  1259,  1271,  1272,  1277,  1287,  1296,  1300,
        1301,  1309,  1310,  1311,  1322,  1328,  1334,  1352,  1417,  1434,  1443,  1455,  1461,
        1494,  1500,  1501,  1503,  1521,  1524,  1533,  1556,  1580,  1583,  1594,  1600,  1641,
        1658,  1666,  1687,  1688,  1700,  1717,  1718,  1719,  1720,  1721,  1723,  1755,  1761,
        1782,  1783,  1801,  1805,  1812,  1839,  1840,  1862,  1863,  1864,  1875,  1900,  1914,
        ...
        2366,  2381,  2382,  2383,  2393,  2394,  2399,  2401,  2492,  2500,  2522,  2557,  2601,
        ...
        5002,  5003,  5004,  5009,  5030,  5033,  5050,  5051,  5054,  5080,  5087,  5100,  5101,
        ...
        5633,  5666,  5678,  5679,  5718,  5730,  5801,  5802,  5810,  5811,  5815,  5822,  5825,
        5850,  5859,  5862,  5877,  5902,  5903,  5904,  5906,  5907,  5910,  5911,  5915,  5922,
        5925,  5950,  5952,  5959,  5960,  5961,  5962,  5963,  5987,  5988,  5989,  5998,  5999,
        6002,  6003,  6004,  6005,  6006,  6007,  6009,  6025,  6059,  6100,  6101,  6106,  6112,
        6123,  6129,  6156,  6346,  6389,  6502,  6510,  6543,  6547,  6565,  6566,  6567,  6580,
        6646,  6666,  6667,  6668,  6669,  6689,  6692,  6699,  6779,  6788,  6789,  6792,  6839,
        6881,  6901,  6969,  7000,  7001,  7002,  7004,  7007,  7019,  7025,  7070,  7100,  7103,
        7106,  7200,  7201,  7402,  7435,  7443,  7496,  7512,  7625,  7627,  7676,  7741,  7777,
        7778,  7800,  7911,  7920,  7921,  7937,  7938,  7999,  8000,  8001,  8002,  8007,  8008,
        8009,  8010,  8011,  8021,  8022,  8031,  8042,  8045,  8080,  8081,  8082,  8083,  8084,
        8085,  8086,  8087,  8088,  8089,  8090,  8093,  8099,  8100,  8180,  8181,  8192,  8193,
        8194,  8200,  8222,  8254,  8290,  8291,  8292,  8300,  8333,  8383,  8400,  8402,  8443,
        8500,  8600,  8649,  8651,  8652,  8654,  8701,  8800,  8873,  8888,  8899,  8994,  9000,
        9001,  9002,  9003,  9009,  9010,  9011,  9040,  9071,  9080,  9081,  9090,  9091,  9099,
        9100,  9101,  9102,  9103,  9110,  9111,  9200,  9207,  9220,  9290,  9415,  9418,  9485,
...
static int SET_http_cookie(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    if (masscan->http.cookies_count <
        sizeof(masscan->http.cookies) / sizeof(masscan->http.cookies[0]))
    {
...
static int SET_http_header(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    if (*name == '[')
    {
        ...
        while (ispunct(*name)) name++;
        name_length = (unsigned) strlen(name);
        while (name_length && ispunct(name[name_length - 1])) name_length--;
    ...
    else if (strchr(value, ':'))
    {
        ...
        while (*value && isspace(*value & 0xFF)) value++;

        /* Trim the name */
        while (name_length && isspace(newname[name_length - 1] & 0xFF)) name_length--;
        newname[name_length] = '\0';
    }
    else
    {
    ...
    /* Add to our list of headers */
    if (masscan->http.headers_count <
        sizeof(masscan->http.headers) / sizeof(masscan->http.headers[0]))
    {
...
static int SET_http_method(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    if (masscan->echo)
    {
        if (masscan->http.method || masscan->echo_all)
            fprintf(masscan->echo, "http-method = %.*s\n", (unsigned) masscan->http.method_length,
                    masscan->http.method);
        return 0;
    }
...
static int SET_http_url(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    if (masscan->echo)
    {
        if (masscan->http.url || masscan->echo_all)
            fprintf(masscan->echo, "http-url = %.*s\n", (unsigned) masscan->http.url_length,
                    masscan->http.url);
        return 0;
    }
    if (masscan->http.url)
...
static int SET_http_host(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    if (masscan->echo)
    {
        if (masscan->http.host || masscan->echo_all)
            fprintf(masscan->echo, "http-host = %.*s\n", (unsigned) masscan->http.host_length,
                    masscan->http.host);
        return 0;
    }
...
static int SET_http_user_agent(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    memcpy(masscan->http.user_agent, value, masscan->http.user_agent_length + 1);
    return CONF_OK;
}
...
static int SET_http_payload(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    if (masscan->echo)
    {
        if (masscan->http.payload || masscan->echo_all)
            fprintf(masscan->echo, "http-payload = %.*s\n", (unsigned) masscan->http.payload_length,
...
static int SET_nmap_payloads(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    if (masscan->echo)
    {
        if ((masscan->payloads.nmap_payloads_filename &&
             masscan->payloads.nmap_payloads_filename[0]) ||
            masscan->echo_all)
...
static int SET_nmap_service_probes(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    if (masscan->echo)
    {
        if ((masscan->payloads.nmap_service_probes_filename &&
             masscan->payloads.nmap_service_probes_filename[0]) ||
            masscan->echo_all)
...
static int SET_output_filename(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    safe_strcpy(masscan->output.filename, sizeof(masscan->output.filename), value);
    return CONF_OK;
}
...
static int SET_pcap_payloads(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    if (masscan->echo)
    {
        if ((masscan->payloads.pcap_payloads_filename &&
             masscan->payloads.pcap_payloads_filename[0]) ||
            masscan->echo_all)
...
static int SET_rotate_directory(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    safe_strcpy(masscan->output.rotate.directory, sizeof(masscan->output.rotate.directory), value);
...
static int SET_shard(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    while (isdigit(*value)) one = one * 10 + (*(value++)) - '0';
    while (ispunct(*value)) value++;
    while (isdigit(*value)) of = of * 10 + (*(value++)) - '0';
...
void masscan_set_parameter(struct Masscan* masscan, const char* name, const char* value)
{
    ...
    else if (EQUALS("adapter", name) || EQUALS("if", name) || EQUALS("interface", name))
    {
        ...
        snprintf(masscan->nic[index].ifname, sizeof(masscan->nic[index].ifname), "%s", value);
    }
             ...
             EQUALS("spoof-address", name) || EQUALS("src-ip", name))
    {
        ...
        switch (err)
        {
            ...
            default:
                ...
                LOG(0,
                    "hint   addresses look like \"192.168.1.23\" or "
                    "\"2001:db8:1::1ce9\".\n");
                exit(1);
        }
    }
    ...
    else if (EQUALS("router-mac", name) || EQUALS("router", name) || EQUALS("dest-mac", name) ||
             EQUALS("destination-mac", name) || EQUALS("dst-mac", name) ||
             EQUALS("target-mac", name))
    {
    ...
    else if (EQUALS("ports", name) || EQUALS("port", name) || EQUALS("dst-port", name) ||
             EQUALS("dest-port", name) || EQUALS("destination-port", name) ||
    ...
    else if (EQUALS("range", name) || EQUALS("ranges", name) || EQUALS("ip", name) ||
             EQUALS("ipv4", name) || EQUALS("dst-ip", name) || EQUALS("dest-ip", name) ||
             EQUALS("destination-ip", name) || EQUALS("target-ip", name))
    {
        int err;
    ...
    else if (EQUALS("exclude", name) || EQUALS("exclude-range", name) ||
             EQUALS("exclude-ranges", name) || EQUALS("exclude-ip", name) ||
    ...
    else if (EQUALS("min-rtt-timeout", name) || EQUALS("max-rtt-timeout", name) ||
             EQUALS("initial-rtt-timeout", name))
    {
        fprintf(stderr,
                "nmap(%s): unsupported: we are asynchronous, so no timeouts, no "
                "RTT tracking!\n",
                name);
        exit(1);
    }
    ...
    else if (EQUALS("redis", name))
    {
        ...
        {
            while (offset < max_offset && isspace(value[offset])) offset++;
        ...
        safe_strcpy(masscan->output.filename, sizeof(masscan->output.filename), "<redis>");
    }
...
static bool is_numable(const char* name)
{
    size_t i;
...
static int is_singleton(const char* name)
{
    static const char* singletons[] = {
        "echo",           "echo-all",     "echo-cidr",     "selftest",
        "self-test",      "regress",      "benchmark",     "system-dns",
        "traceroute",     "version",      "version-light", "version-all",
        "version-trace",  "osscan-limit", "osscan-guess",  "badsum",
        "reason",         "open",         "open-only",     "packet-trace",
        "release-memory", "log-errors",   "append-output", "webxml",
        "no-stylesheet",  "heartbleed",   "ticketbleed",   "send-eth",
        "send-ip",        "iflist",       "nmap",          "trace-packet",
        "pfring",         "sendq",        "ping",          "ping-sweep",
        "nobacktrace",    "backtrace",    "infinite",      "nointeractive",
        "interactive",    "status",       "nostatus",      "read-range",
        "read-ranges",    "readrange",    "read-ranges",   0};
    size_t i;
...
void masscan_command_line(struct Masscan* masscan, int argc, char* argv[])
{
            ...
            switch (argv[i][1])
            {
                ...
                case 's': /* NMAP: scan type */
                    if (argv[i][3] == '\0' && !isdigit(argv[i][2] & 0xFF))
                    {
                        ...
                        for (j = 2; argv[i][j]; j++) switch (argv[i][j])
                            {
                                case 'A':
                ...
                {
                    int v;
                    for (v = 1; argv[i][v] == 'v'; v++) LOG_add_level(1);
                }
                break;
    ...
    {
        fprintf(stderr,
                "[-] WARNING: --seed <num> is not specified\n    HINT: all "
                "shards must share the same seed\n");
    }
}
 ...
 ***************************************************************************/
void masscan_echo(struct Masscan* masscan, FILE* fp, unsigned is_echo_all)
{
    unsigned i;
    unsigned l = 0;
    ...
    {
        for (i = 0; i < masscan->nic_count; i++) masscan_echo_nic(masscan, fp, i);
    }
    ...
    for (i = 0; i < masscan->targets.ipv4.count; i++)
    {
        ...
        if (range.begin == range.end)
        {
            fprintf(fp, "range = %u.%u.%u.%u", (range.begin >> 24) & 0xFF,
                    (range.begin >> 16) & 0xFF, (range.begin >> 8) & 0xFF,
                    (range.begin >> 0) & 0xFF);
        }
        else if (range_is_cidr(range, &prefix_bits))
        {
            fprintf(fp, "range = %u.%u.%u.%u/%u", (range.begin >> 24) & 0xFF,
                    (range.begin >> 16) & 0xFF, (range.begin >> 8) & 0xFF,
                    (range.begin >> 0) & 0xFF, prefix_bits);
        }
        else
        {
            fprintf(fp, "range = %u.%u.%u.%u-%u.%u.%u.%u", (range.begin >> 24) & 0xFF,
                    (range.begin >> 16) & 0xFF, (range.begin >> 8) & 0xFF,
                    (range.begin >> 0) & 0xFF, (range.end >> 24) & 0xFF, (range.end >> 16) & 0xFF,
 ...
 *  10.0.0.128/25
 ***************************************************************************/
void masscan_echo_cidr(struct Masscan* masscan, FILE* fp, unsigned is_echo_all)
{
    unsigned i;
    ...
    for (i = 0; i < masscan->targets.ipv4.count; i++)
    {
        ...
        for (;;)
        {
            ...
            fprintf(fp, "%u.%u.%u.%u/%u\n", (cidr.begin >> 24) & 0xFF, (cidr.begin >> 16) & 0xFF,
                    (cidr.begin >> 8) & 0xFF, (cidr.begin >> 0) & 0xFF, prefix_length);
...
static void trim(char* line, size_t sizeof_line)
{
    ...
    while (isspace(*line & 0xFF)) memmove(line, line + 1, sizeof_line--);
    while (*line && isspace(line[sizeof_line - 1] & 0xFF)) line[--sizeof_line] = '\0';
}

...
/***************************************************************************
 ***************************************************************************/
static void telnet_parse(const struct Banner1* banner1, void* banner1_private,
...
/***************************************************************************
 ***************************************************************************/
static void* telnet_init(struct Banner1* banner1)
{
    UNUSEDPARM(banner1);
    return 0;
}
...
/***************************************************************************
 ***************************************************************************/
static int telnet_selftest_item(const char* input, const char* output)
{
     ...
     */
    telnet_parse(banner1, 0, pstate, (const unsigned char*) input, strlen(input), banout1, 0);
    // fprintf(stderr, "%.*s\n", (int)banout_string_length(banout1, PROTO_TELNET),
    // banout_string(banout1, PROTO_TELNET));
    /*
...
/***************************************************************************
 ***************************************************************************/
static int telnet_selftest(void)
{
    struct
    {
        const char* input;
        const char* output;
    } tests[] = {{"\xff\xfd\x1flogin:", "login:"},
...
const struct ProtocolParserStream banner_telnet = {
    "telnet", 23, "\xff\xf6", 2, 0, telnet_selftest, telnet_init, telnet_parse,
};

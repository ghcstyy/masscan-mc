...
/***************************************************************************
 ***************************************************************************/
void blackrock_init(struct BlackRock* br, uint64_t range, uint64_t seed, unsigned rounds)
{
 ...
 * which
 ***************************************************************************/
static inline uint64_t READ(uint64_t r, uint64_t R, uint64_t seed)
{
...
/***************************************************************************
 ***************************************************************************/
static inline uint64_t UNENCRYPT(unsigned r, uint64_t a, uint64_t b, uint64_t m, uint64_t seed)
{
    uint64_t L, R;
    unsigned j;
    uint64_t tmp;
...
/***************************************************************************
 ***************************************************************************/
uint64_t blackrock_shuffle(const struct BlackRock* br, uint64_t m)
{
    uint64_t c;

    c = ENCRYPT(br->rounds, br->a, br->b, m, br->seed);
    while (c >= br->range) c = ENCRYPT(br->rounds, br->a, br->b, c, br->seed);
...
/***************************************************************************
 ***************************************************************************/
uint64_t blackrock_unshuffle(const struct BlackRock* br, uint64_t m)
{
    uint64_t c;

    c = UNENCRYPT(br->rounds, br->a, br->b, m, br->seed);
    while (c >= br->range) c = UNENCRYPT(br->rounds, br->a, br->b, c, br->seed);
 ...
 ***************************************************************************/
static unsigned blackrock_verify(struct BlackRock* br, uint64_t max)
{
    unsigned char* list;
    uint64_t i;

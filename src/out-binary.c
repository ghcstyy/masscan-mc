...
static void _put_byte(unsigned char *buf, size_t length, size_t *r_offset,
...
static void _put_short(unsigned char *buf, size_t length, size_t *r_offset,
                       unsigned long long num) {
  size_t offset = *r_offset;
  (*r_offset) += 2;
  if (*r_offset <= length) {
...
static void _put_long(unsigned char *buf, size_t length, size_t *r_offset,
                      unsigned long long num) {
  size_t offset = *r_offset;
  (*r_offset) += 8;
  if (*r_offset <= length) {
...
/****************************************************************************
 ****************************************************************************/
static void binary_out_status_ipv6(struct Output *out, FILE *fp,
                                   time_t timestamp, int status, ipaddress ip,
...
/****************************************************************************
 ****************************************************************************/
static void binary_out_status(struct Output *out, FILE *fp, time_t timestamp,
  ...
  if (ip.version == 6) {
    binary_out_status_ipv6(out, fp, timestamp, status, ip, ip_proto, port,
                           reason, ttl);
    return;
  }
...
/****************************************************************************
 ****************************************************************************/
static void binary_out_banner_ipv6(struct Output *out, FILE *fp,
...
/****************************************************************************
 ****************************************************************************/
static void binary_out_banner(struct Output *out, FILE *fp, time_t timestamp,
  ...
  if (ip.version == 6) {
    binary_out_banner_ipv6(out, fp, timestamp, ip, ip_proto, port, proto, ttl,
                           px, length);
    return;
  }

 ...
 ***************************************************************************/
static size_t cc_parse(struct BannerOutput *banout, struct RDPSTUFF *rdp,
 ...
 * @return the number of bytes processed
 ***************************************************************************/
static size_t cotp_parse(struct BannerOutput *banout, struct RDPSTUFF *rdp,
                         const unsigned char *px, size_t length) {
  size_t offset;
...
/***************************************************************************
 ***************************************************************************/
static int rdp_selftest_item(const char *input, size_t length,
                             const char *expect) {
   ...
   */
  rdp_parse(banner1, 0, pstate, (const unsigned char *)input, length, banout1,
            &more);
...
const struct ProtocolParserStream banner_rdp = {
    "rdp", 3389,         rdp_hello, sizeof(rdp_hello) - 1,
    0,     rdp_selftest, rdp_init,  rdp_parse,
};

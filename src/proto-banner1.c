...
struct Patterns patterns[] = {
    ...
    {"220-", 4, PROTO_FTP, SMACK_ANCHOR_BEGIN, 0}, {"220 ", 4, PROTO_FTP, SMACK_ANCHOR_BEGIN, 1},
                           ...
                           struct stack_handle_t* socket)
    {
        ...
        switch (tcb_state->app_proto)
        {
            ...
            case PROTO_HEUR:
                ...
                break;
            case PROTO_FTP:
                banner_ftp.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                 socket);
                break;
            case PROTO_SMTP:
                banner_smtp.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                  socket);
                break;
            ...
            case PROTO_TELNET:
                ...
                break;
            case PROTO_RDP:
                banner_rdp.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                 socket);
                break;
            case PROTO_POP3:
                banner_pop3.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                  socket);
                break;
            case PROTO_IMAP4:
            ...
            case PROTO_SSH2:
                ...
                banner_ssh.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                 socket);
                break;
            case PROTO_HTTP:
                banner_http.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                  socket);
                break;
            case PROTO_SSL3:
                banner_ssl.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                 socket);
                break;
            case PROTO_SMB:
                banner_smb1.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                  socket);
                break;
            case PROTO_VNC_RFB:
                banner_vnc.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                 socket);
                break;
            ...
            case PROTO_VERSIONING:
                banner_versioning.parse(banner1, banner1->http_fields, tcb_state, px, length,
                                        banout, socket);
                break;
            case PROTO_MC:
                banner_mc.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                socket);
                break;
            case PROTO_MINECRAFT:
                banner_minecraft.parse(banner1, banner1->http_fields, tcb_state, px, length, banout,
                                       socket);
                break;
            default:

...
static void doit4(register uint32_t *a, register long x, register long y,
                  int64_t start) {
  long i0;
  long y0;
  register long i;
...
static void doit6(register uint32_t *a, register long x, register long y,
                  int64_t start) {
  long i0;
  long y0;
  register long i;
...
static void doit12(register uint32_t *a, register long x, register long y,
                   int64_t start) {
  register long i;
  register uint32_t data;
  register uint32_t bits;
...
static void squarefree1big(uint32_t (*buf)[B32], uint64_t base, uint32_t q,
                           uint64_t qq) {
  uint64_t i;
  uint32_t pos;
  int n;
...
static void squarefree49big(uint32_t (*buf)[B32], uint64_t base, uint32_t q,
                            uint64_t qq) {
  uint64_t i;
  uint32_t pos;
  int n;

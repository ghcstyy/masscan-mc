...
/****************************************************************************
 ****************************************************************************/
static void cert_out_open(struct Output* out, FILE* fp)
{
    UNUSEDPARM(out);
    UNUSEDPARM(fp);
}
...
/****************************************************************************
 ****************************************************************************/
static void cert_out_close(struct Output* out, FILE* fp)
{
    UNUSEDPARM(out);
...
/******************************************************************************
 ******************************************************************************/
static void cert_out_status(struct Output* out, FILE* fp, time_t timestamp, int status,
...
/******************************************************************************
 ******************************************************************************/
static void cert_out_banner(struct Output* out, FILE* fp, time_t timestamp, ipaddress ip,
...
const struct OutputType certs_output = {
    "cert", 0, cert_out_open, cert_out_close, cert_out_status, cert_out_banner};

...
#define ex16le(px) (*((unsigned char*) (px) + 0) << 0 | *((unsigned char*) (px) + 1) << 8)
...
/****************************************************************************
 ****************************************************************************/
unsigned preprocess_frame(const unsigned char* px, unsigned length, unsigned link_type,
...
parse_ipv4:
{
    ...
    info->src_ip.ipv4 =
        px[offset + 12] << 24 | px[offset + 13] << 16 | px[offset + 14] << 8 | px[offset + 15] << 0;
    info->src_ip.version = 4;
    info->dst_ip.ipv4 =
        px[offset + 16] << 24 | px[offset + 17] << 16 | px[offset + 18] << 8 | px[offset + 19] << 0;
...
parse_ipv6:
{
    ...
    info->src_ip.ipv6.hi =
        0ULL | (uint64_t) px[offset + 8] << 56ULL | (uint64_t) px[offset + 9] << 48ULL |
        (uint64_t) px[offset + 10] << 40ULL | (uint64_t) px[offset + 11] << 32ULL |
        (uint64_t) px[offset + 12] << 24ULL | (uint64_t) px[offset + 13] << 16ULL |
        (uint64_t) px[offset + 14] << 8ULL | (uint64_t) px[offset + 15] << 0ULL;
    info->src_ip.ipv6.lo =
        0ULL | (uint64_t) px[offset + 16] << 56ULL | (uint64_t) px[offset + 17] << 48ULL |
        (uint64_t) px[offset + 18] << 40ULL | (uint64_t) px[offset + 19] << 32ULL |
        (uint64_t) px[offset + 20] << 24ULL | (uint64_t) px[offset + 21] << 16ULL |
        (uint64_t) px[offset + 22] << 8ULL | (uint64_t) px[offset + 23] << 0ULL;

    info->dst_ip.version = 6;
    info->dst_ip.ipv6.hi =
        0ULL | (uint64_t) px[offset + 24] << 56ULL | (uint64_t) px[offset + 25] << 48ULL |
        (uint64_t) px[offset + 26] << 40ULL | (uint64_t) px[offset + 27] << 32ULL |
        (uint64_t) px[offset + 28] << 24ULL | (uint64_t) px[offset + 29] << 16ULL |
        (uint64_t) px[offset + 30] << 8ULL | (uint64_t) px[offset + 31] << 0ULL;
    info->dst_ip.ipv6.lo =
        0ULL | (uint64_t) px[offset + 32] << 56ULL | (uint64_t) px[offset + 33] << 48ULL |
        (uint64_t) px[offset + 34] << 40ULL | (uint64_t) px[offset + 35] << 32ULL |
        (uint64_t) px[offset + 36] << 24ULL | (uint64_t) px[offset + 37] << 16ULL |
        (uint64_t) px[offset + 38] << 8ULL | (uint64_t) px[offset + 39] << 0ULL;
...
parse_vlanmpls:
     ...
     * header in the stack*/
    while (offset + 4 < length && !(px[offset + 2] & 1)) offset += 4;
...
parse_linktype:
    ...
    switch (link_type)
    {
        ...
        case 0x69:
            goto parse_wifi;
        case 113:
            goto parse_linux_sll; /* LINKTYPE_LINUX_SLL DLT_LINUX_SLL */
        case 119:
...
parse_arp:
    ...
    info->ip_offset = offset;
    {
        ...
        info->src_ip.version = 4;
        info->src_ip.ipv4 =
            px[offset + hardware_length + 0] << 24 | px[offset + hardware_length + 1] << 16 |
            px[offset + hardware_length + 2] << 8 | px[offset + hardware_length + 3] << 0;
        info->dst_ip.version = 4;

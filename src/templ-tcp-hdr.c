 ...
 */
static void safe_memmove(unsigned char *buf, size_t length, size_t to,
                         size_t from, size_t chunklength) {
 ...
 */
static void safe_memset(unsigned char *buf, size_t length, size_t offset, int c,
                        size_t chunklength) {
 ...
 ***************************************************************************/
static int _consistancy_check(const unsigned char *buf, size_t length,
 ...
 ***************************************************************************/
static struct tcp_opt_t tcp_find_opt(const unsigned char *buf, size_t length,
                                     unsigned in_kind) {
...
static bool tcp_add_opt(unsigned char **inout_buf, size_t *inout_length,
                        unsigned opt_kind, unsigned opt_length,
...

  {
    ...
    adjust =
        _insert_field(&buf, &length, old_begin, old_end, new_field, new_length);
    hdr.max += adjust;
  }
...
/***************************************************************************
 ***************************************************************************/
static unsigned tcp_get_mss(const unsigned char *buf, size_t length,
                            bool *is_found) {
...
/***************************************************************************
 ***************************************************************************/
static unsigned tcp_get_wscale(const unsigned char *buf, size_t length,
                               bool *is_found) {
  struct tcp_opt_t opt;
  unsigned result = 0;
...
/***************************************************************************
 ***************************************************************************/
static unsigned tcp_get_sackperm(const unsigned char *buf, size_t length,
                                 bool *is_found) {
  struct tcp_opt_t opt;

...
static void vnc_append_sectype(struct BannerOutput* banout, unsigned sectype)
{
    char foo[16];
...
/***************************************************************************
 ***************************************************************************/
static void vnc_parse(const struct Banner1* banner1, void* banner1_private,
...
/***************************************************************************
 ***************************************************************************/
static void* vnc_init(struct Banner1* banner1)
{
    UNUSEDPARM(banner1);
    return 0;
}
...
const struct ProtocolParserStream banner_vnc = {
    "vnc", 5900, 0, 0, 0, vnc_selftest, vnc_init, vnc_parse,
};
